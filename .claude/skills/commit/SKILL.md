...
The bad examples either restate **what** the diff already shows or say nothing useful. The description should answer "why was this change necessary?" or "what problem does this solve?", not restate the code changes.
